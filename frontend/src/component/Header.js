    ...
    <div className='flex items-center h-full justify-between'>
      ...
      <div className='flex items-center gap-4 md:gap-7'>
        <nav className='flex gap-4 md:gap-6 text-base md:text-lg hidden md:flex'>
         <Link to={""}>Home</Link>
         <Link to={"menu/640acaadbad55c3a5a5f7046"}>Menu</Link>
        ...
        <div className='text-slate-600'onClick={handleShowMenu}>
            ...
            {userData.image ? <img src={userData.image} className="h-full w-full " alt="img" />:<HiOutlineUserCircle/>}
         ...
         <Link to={"menu/640acaadbad55c3a5a5f7046"} className="px-2 py-1 ">Menu</Link>
